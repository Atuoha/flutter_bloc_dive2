...
class TodoAppCubit extends StatefulWidget {
  const TodoAppCubit({Key? key}) : super(key: key);
  static const routeName = "/todo_cubit";

  @override
  State<TodoAppCubit> createState() => _TodoAppCubitState();
}

class _TodoAppCubitState extends State<TodoAppCubit> {
